...
br.addheaders = [('User-Agent', 'Opera/9.80 (Android; Opera Mini/47.2.2254.147957 U; id) Presto/2.12.423 Version/12.16')]
    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.youtube.com/channel/UCmhp9TjTjr1kr5-pHV6CBng')
                time.sleep(2)
                menu()
